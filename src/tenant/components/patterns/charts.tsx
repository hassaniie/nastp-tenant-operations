...
function resolve(isDark: boolean): VizTheme {
  return {
    series: [read('--viz-1'), read('--viz-2'), read('--viz-3'), read('--viz-4'), read('--viz-5'), read('--viz-6')],
    sequential: [read('--seq-1'), read('--seq-2'), read('--seq-3'), read('--seq-4'), read('--seq-5'), read('--seq-6'), read('--seq-7')],
    grid: read('--viz-grid'),
    axis: read('--viz-axis'),
