/**
 * badge — vendored from the ReUI registry.
 *
 * Source: https://reui.io/r/radix-nova/badge.json
 * Installed from reui-registry/badge.json — do not edit by hand; re-install to update.
 *
