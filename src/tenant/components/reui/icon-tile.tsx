/**
 * icon-tile — vendored from the ReUI registry.
 *
 * Source: https://reui.io/r/radix-nova/icon-tile.json
 * Installed from reui-registry/icon-tile.json — do not edit by hand; re-install to update.
 *
  ...
  ],
  {
    variants: {
      variant: {
        ...
        elevated:
          "border-2 border-background bg-muted-surface text-accent-foreground shadow-[0_1px_3px_0_rgb(0_0_0/0.14)] dark:border",
        /**
        ...
        frame: [
          "isolate border border-border bg-muted-surface/50 p-(--icon-tile-inset)",
          "after:absolute after:-z-10 after:inset-(--icon-tile-inset)",
          "after:rounded-[calc(var(--icon-tile-radius)-var(--icon-tile-inset))]",
