/**
 * frame — vendored from the ReUI registry.
 *
 * Source: https://reui.io/r/radix-nova/frame.json
 * Installed from reui-registry/frame.json — do not edit by hand; re-install to update.
 *
...
const frameVariants = cva(
  [
    "relative flex flex-col bg-muted-surface/50 gap-(--frame-gap) px-(--frame-px) py-(--frame-py) rounded-(--frame-radius)",
  ...
  ],
  {
    variants: {
      variant: {
        ...
        inverse:
          "[--frame-panel-bg:color-mix(in_oklch,var(--color-muted-surface)_40%,transparent)] border border-[var(--frame-border-color)] bg-background bg-clip-padding",
