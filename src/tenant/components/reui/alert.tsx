/**
 * alert — vendored from the ReUI registry.
 *
 * Source: https://reui.io/r/radix-nova/alert.json
 * Installed from reui-registry/alert.json — do not edit by hand; re-install to update.
 *
