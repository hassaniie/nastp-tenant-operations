...
- [ ] Shared semantic foundations and conventions
- [ ] Consolidated production primitives and states
- [ ] Reusable patterns and protected development workbench
- [ ] Service Requests proof workflow
...
| tabs.tsx | Reuse Radix Tabs. Consolidate segmented controls into accessible native radio choices; fix tab keyboard behavior. |
